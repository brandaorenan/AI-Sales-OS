...
> Overview, capabilities, authentication summary, output formats, HTTP verbs, request structure and REST resources overview.

---

## Introduction to the Magento 1.x REST API

*Source: <https://devdocs-openmage.org/guides/m1x/api/rest/introduction.html>*
...
*Source: <https://devdocs-openmage.org/guides/m1x/api/rest/Resources/resources.html>*
