...
| `comercio-magento.architecture.json` | concierge de compras Magento (Entregas 2-6 do plano de 2026-09-06) — 21 peças, 26 arestas, 6 faixas; catálogo, apresentação de produto com imagem, carrinho executor comercial e handoff explícito entre agentes reusando o job `followup_turn`; não-ligações declaradas: frete/cupom (descartado pelo dono do produto) e o papel Operador (nenhuma tool comercial tem equivalente lá) |
