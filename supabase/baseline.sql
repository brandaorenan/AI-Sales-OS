...
-- ---- ciclo de vida do contexto do agente (migration 0142) ----
...
-- ---- hard reset atômico do contexto (migration 0143) ----
...
-- ---- debounce inbound por organização (migration 0144) ----
...
-- ---- hard reset não é de quem está logado (migration 0145) ----
-- `fn_hard_reset_contact_context` (0143) é DEFINER e ESCREVE, e recebe a
...
-- tenant. O `revoke ... from public` da 0143 não cobre isso — são duas origens
