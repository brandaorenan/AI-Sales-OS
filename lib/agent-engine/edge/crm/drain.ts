 ...
 * TRAVADA, não o caso normal. Foi pra 90s com esse conserto.
 *
 * Foi pra 120s em 2026-09-03, quando um áudio real (cliente "Alfran") levou
 * ~86s para transcrever: o turno estourou o teto de 90s, respondeu "não
 * consegui ouvir seu áudio" às 14:25:46, e a transcrição correta só ficou
 * pronta às 14:26:04 — 18s tarde demais, e o cliente teve que digitar a
 * pergunta de novo. Medição de p50/p90/p99 de conclusão de transcrição nos
 * últimos 7 dias desta instalação: 14s / 407s / 2538s — a cauda longa
 * (minutos) é de retry após falha transitória, não do Whisper em si, e
 * nenhum teto razoável a cobre sem o cliente esperando minutos pela primeira
 * resposta. 120s cobre o caso comum de transcrição lenta (como o do Alfran)
 * sem impor essa espera longa.
 */
