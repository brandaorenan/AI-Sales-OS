...
export const NAV_DESTINATIONS: NavDestination[] = [
  ...
  {
    // Onda 5: a rajada. O cliente manda cinco mensagens seguidas e o agente
    // respondia cinco vezes, cada uma sem saber das outras. O tempo de espera
    // antes de responder é decisão de operação — precisa de tela, não de env.
    // Vivia no hub de Configurações escrito à mão; com o registro, a porta é
    // esta, ao lado das outras peças de montar o agente.
