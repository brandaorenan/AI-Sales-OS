...
export const DICIONARIO: Traducoes = {
  ...
  // ─── Ciclo de vida do contexto do agente (Spec 16, C3-01) ───
  "Não foi possível carregar a configuração de rajada.": {
    es: "No fue posible cargar la configuración de ráfaga.",
  },
  "Agrupar mensagens em rajada": { es: "Agrupar mensajes en ráfaga" },
  "Mensagens do mesmo contato dentro desta janela viram uma única resposta do agente — evita responder no meio de uma sequência no WhatsApp.":
    {
      es: "Los mensajes del mismo contacto dentro de esta ventana se convierten en una única respuesta del agente — evita responder en medio de una secuencia en WhatsApp.",
    },
  "Ativar agrupamento": { es: "Activar agrupación" },
  "Segundos de espera": { es: "Segundos de espera" },
  "Entre 0 e 30 segundos. Desligado = responde na hora.": {
    es: "Entre 0 y 30 segundos. Apagado = responde al instante.",
  },
  "Comportamento do agente": { es: "Comportamiento del agente" },
  "Como o agente agrupa e responde mensagens nesta organização.": {
    es: "Cómo el agente agrupa y responde mensajes en esta organización.",
  },
  "Recomeçar o atendimento nesta etapa": { es: "Reiniciar la atención en esta etapa" },
  "Quando o negócio chegar em": { es: "Cuando el negocio llegue a" },
  "a IA recomeça do zero": { es: "la IA reinicia desde cero" },
  "Quando o negócio chegar aqui, a IA recomeça do zero": {
    es: "Cuando el negocio llegue aquí, la IA reinicia desde cero",
  },
  "A IA esquece o que foi conversado, mas continua sabendo quem é o cliente e o que ele já comprou. O histórico completo continua visível para a sua equipe.":
    {
      es: "La IA olvida lo que se conversó, pero sigue sabiendo quién es el cliente y qué ya compró. El historial completo sigue visible para su equipo.",
    },
  "Esperar": { es: "Esperar" },
  "Dias de carência antes de recomeçar em": { es: "Días de gracia antes de reiniciar en" },
  "dias antes de recomeçar": { es: "días antes de reiniciar" },
  "Tempo para o pós-venda acontecer. Se o cliente voltar antes disso, a IA ainda lembra da conversa.":
    {
      es: "Tiempo para que la posventa suceda. Si el cliente vuelve antes de eso, la IA todavía recuerda la conversación.",
    },
  "Contexto apagado.": { es: "Contexto borrado." },
  "Apagar o contexto deste contato": { es: "Borrar el contexto de este contacto" },
  "Isso apaga as mensagens, o resumo, as notas e o estado do funil da IA para": {
    es: "Esto borra los mensajes, el resumen, las notas y el estado del embudo de la IA para",
  },
  ". O contato e o negócio continuam existindo, com toda a ficha e o histórico de pedidos.": {
    es: ". El contacto y el negocio siguen existiendo, con toda la ficha y el historial de pedidos.",
  },
  ...
  "Remover também o que a IA aprendeu dessas conversas na base de conhecimento": {
    es: "Eliminar también lo que la IA aprendió de estas conversaciones en la base de conocimiento",
  },
  "Marque se estas conversas foram testes e não devem servir de referência para outros atendimentos.":
    {
      es: "Marque si estas conversaciones fueron pruebas y no deben servir de referencia para otras atenciones.",
    },
  "Apagar contexto": { es: "Borrar contexto" },
};
